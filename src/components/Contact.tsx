...
export default function Contact() {
  ...
  return (
    <section ref={sectionRef} id="contact" className="py-20 px-6 bg-[#0B132B]/80 border-t border-white/5">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="space-y-2">
          ...
          {/* Judul H2 dengan Garis Bawah Aktif Otomatis & Text Safe String */}
